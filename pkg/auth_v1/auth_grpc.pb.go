...
type AuthV1Client interface {
	...
	GetAllUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllUsers_Response, error)
	...
	Update(ctx context.Context, in *Update_Request, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *authV1Client) GetAllUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllUsers_Response, error) {
...
func (c *authV1Client) Delete(ctx context.Context, in *Delete_Request, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *authV1Client) Update(ctx context.Context, in *Update_Request, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *authV1Client) Healthz(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type AuthV1Server interface {
	...
	GetAllUsers(context.Context, *emptypb.Empty) (*GetAllUsers_Response, error)
	Delete(context.Context, *Delete_Request) (*emptypb.Empty, error)
	Create(context.Context, *Create_Request) (*Create_Response, error)
	Update(context.Context, *Update_Request) (*emptypb.Empty, error)
...
func (UnimplementedAuthV1Server) GetAllUsers(context.Context, *emptypb.Empty) (*GetAllUsers_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllUsers not implemented")
}
func (UnimplementedAuthV1Server) Delete(context.Context, *Delete_Request) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedAuthV1Server) Create(context.Context, *Create_Request) (*Create_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedAuthV1Server) Update(context.Context, *Update_Request) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedAuthV1Server) Healthz(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _AuthV1_GetAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthV1Server).GetAllUsers(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthV1_Healthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthV1Server).Healthz(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
